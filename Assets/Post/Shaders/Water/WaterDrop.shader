Shader "Unlit/GamePix/WaterDrop"
{
    Properties
    {
...
;            }
            ...
            float3 WaterLayer(float2 UV, float t)
            {
            ...
            fixed4 frag (v2f i) : SV_Target
            {
              ...
              float3 drops = WaterLayer(i.uv, t);
              drops += WaterLayer(i.uv * 3.5 - 5.52, t);
              
               col = tex2Dlod(_MainTex,float4(i.uv + drops.xy * _Distortion,0,0));        //뮬벙율 텍스쳐화
